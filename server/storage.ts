...
export class MemStorage implements IStorage {
    ...
    const dinosaurData: InsertDinosaur[] = [
      {
        ...
        personality: "리더십의 왕",
        description:
          "강한 리더십과 결단력을 가진 당신! 어떤 상황에서도 앞장서서 문제를 해결하는 타입이에요.",
      ...
      },
      {
        ...
        description:
          "온화하고 신중한 성격으로 가족과 친구들을 보호하는 따뜻한 마음을 가진 당신입니다.",
        period: "백악기 후기 (약 6,800만 년 전)",
      ...
      },
      {
        ...
        personality: "영리한 전략가",
        description:
          "뛰어난 지능과 전략적 사고를 가진 당신! 문제를 창의적으로 해결하는 능력이 탁월해요.",
      ...
      },
      {
        ...
        personality: "온화한 거인",
        description:
          "마음이 넓고 포용력이 뛰어난 당신! 다른 사람들에게 안정감과 위로를 주는 존재예요.",
      ...
      },
      {
        ...
        personality: "신중한 방어자",
        description:
          "신중하고 차분한 성격으로 주변을 잘 관찰하며 필요할 때 확실한 행동을 취하는 당신입니다.",
        period: "쥐라기 후기 (약 1억 5천만 년 전)",
      ...
      },
      {
        ...
        description:
          "자유롭고 모험을 좋아하는 당신! 새로운 경험과 도전을 두려워하지 않는 용감한 영혼이에요.",
      ...
      },
      {
        ...
        personality: "독특한 개성파",
        description:
          "남들과는 다른 독특한 매력을 가진 당신! 자신만의 스타일을 추구하며 개성이 강해요.",
      ...
      },
      {
        ...
        personality: "든든한 수호자",
        description:
          "믿음직하고 안정적인 성격으로 주변 사람들에게 든든한 지원군이 되어주는 당신입니다.",
      ...
      },
      {
        ...
        personality: "활발한 사교가",
        description:
          "밝고 활발한 성격으로 사람들과 어울리기를 좋아하는 당신! 분위기 메이커 역할을 잘해요.",
      ...
      },
      {
        ...
        personality: "소통의 달인",
        description:
          "뛰어난 소통 능력으로 사람들 사이의 다리 역할을 잘하는 당신! 공감 능력이 뛰어나요.",
      ...
      },
      {
        ...
        description:
          "열정적이고 경쟁심이 강한 당신! 목표를 향해 끝까지 포기하지 않는 투지를 가지고 있어요.",
        period: "쥐라기 후기 (약 1억 5천만 년 전)",
      ...
      },
      {
        ...
        personality: "친근한 조력자",
        description:
          "친근하고 도움을 주기 좋아하는 당신! 다른 사람의 성공을 위해 기꺼이 지원하는 따뜻한 마음을 가졌어요.",
        period: "쥐라기 후기 (약 1억 5천만 년 전)",
        traits: ["친근함", "협력", "지원", "겸손"],
        matchingScore: {
          collaborative: 10,
      ...
      },
      {
        ...
        personality: "스피드의 화신",
        description:
          "빠른 판단력과 실행력을 가진 당신! 신속하게 움직이며 효율성을 추구하는 성격이에요.",
      ...
      },
      {
        ...
        personality: "평온한 철학자",
        description:
          "깊이 있는 사고를 하며 평온함을 추구하는 당신! 내면의 성찰을 통해 지혜를 얻는 타입이에요.",
        period: "백악기 후기 (약 7,000만 년 전)",
      ...
      },
      {
        ...
        description:
          "상상력이 풍부하고 창의적인 당신! 남들이 보지 못하는 것을 발견하는 특별한 능력이 있어요.",
      ...
      },
      {
        ...
        personality: "독특한 예술가",
        description:
          "예술적 감성과 독특한 표현력을 가진 당신! 자신만의 방식으로 세상을 아름답게 만들어요.",
  ...
  async getAllQuizQuestions(): Promise<QuizQuestion[]> {
    return Array.from(this.quizQuestions.values()).sort(
      (a, b) => a.order - b.order
    );
  }
